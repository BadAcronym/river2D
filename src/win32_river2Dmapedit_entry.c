...
#ifdef DEBUG
    #define LIBPATH_SOFTWARE "./bin/river2Dsoftware_win64/debug/"
#else
    #define LIBPATH_SOFTWARE "./bin/river2Dsoftware_win64/release/"
#endif
...
(
    ...
    HMODULE software = LoadLibraryA(LIBPATH_SOFTWARE "river2Dsoftware.dll");
    if(!software)
    {
